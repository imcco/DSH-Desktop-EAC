    ...
    factory: function (require) {
      ...
      function BranchIcon(size) {
        ...
        return h('svg', {
          ...
          h('path', { fillRule: 'evenodd', clipRule: 'evenodd', d: BRANCH_ICON_PATH, fill: 'currentColor' })
        );
      }
      var POLL_MS = 15000;
      var LOG_COUNT = 10;
